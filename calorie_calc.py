...
out = open("Date_stocate.txt", "a")


def user_info():
    name = input("What is your name: ")
    out.write("                             Datele stocate pentru persoana " + name +" sunt:")
    out.write("\n")
    out.write("\n")
    out.write("Numele persoanei este: ")
    out.write(name)
...
def calculate_activity(bmr_result):
    ...
    out.write("\n")
    out.write("Activity level: ")
    out.write(activity_level)
    out.write("\n")
